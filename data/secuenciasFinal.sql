...
CREATE TABLE HTA_CONVENCION
	...
	ALTER TABLE HTA_CONVENCION
		...
		CHECK (NUMASISTENETS BETWEEN 50 AND 10000)
	ENABLE;
	
	ALTER TABLE HTA_CONVENCION
		ADD CONSTRAINT HTA_CONVENCION_ESTADO
		CHECK (ESTADO IN ('R','I','C'))
	ENABLE;

CREATE TABLE HTA_CONVENCION_SERVICIO
	(IDCONVENCION NUMBER,
	IDSERVICIO NUMBER,
	CONSTRAINT HTA_CONVENCION_SERVICIO_PK PRIMARY KEY(IDCONVENCION,IDSERVICIO));
...
CREATE TABLE HTA_CONVENCION_HABITACION
	(IDCONVENCION NUMBER,
	IDHABITACION NUMBER,
	CONSTRAINT HTA_CONVENCION_HABITACION_PK PRIMARY KEY(IDCONVENCION,IDHABITACION));
